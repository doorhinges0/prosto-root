...
import static com.facebook.presto.hbase.HbaseQueryRunner.createHbaseQueryRunner;
import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertFalse;
import static org.testng.Assert.assertTrue;

public class TestHbaseDistributedQueries extends AbstractTestDistributedQueries {

    public TestHbaseDistributedQueries() {
        super(() -> createHbaseQueryRunner(ImmutableMap.of()));
    }
    ...
    {
        @Language("SQL")
        String query = "SELECT UUID() AS uuid, orderdate, orderkey FROM orders";
